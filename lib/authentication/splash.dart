...
class SplashScreen extends StatefulWidget {
  ...
  final String? userSsid; // Add this parameter

  const SplashScreen({
    super.key,
    required this.onConnectionChecked,
    this.userSsid, // Make it optional
  });
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  // Get target SSID from user or use default
  String get _targetSsid {
    return widget.userSsid ?? 'IoGen_Speaker'; // Fallback to default
  }
  ...
  Future<void> _checkWifiConnection() async {
    try {
      ...
      if (connectivityResult.contains(ConnectivityResult.wifi)) {
        ...
        // Use _targetSsid instead of hardcoded value
        ...
        String connectionStatus = isTargetWifi
            ? "Connected to $_targetSsid" // Dynamic SSID
